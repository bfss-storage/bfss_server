...
elseif( NOT Log4cxx_FOUND )
  ...
  find_path( Log4cxx_INCLUDES_DIR log4cxx/logger.h )

  message(STATUS "Searching for libLog4cxx")
  find_library( Log4cxx_LIBRARYS log4cxx )

  include( FindPackageHandleStandardArgs )
  FIND_PACKAGE_HANDLE_STANDARD_ARGS( Log4cxx Log4cxx_INCLUDES_DIR Log4cxx_LIBRARYS )
  if( LOG4CXX_FOUND )
